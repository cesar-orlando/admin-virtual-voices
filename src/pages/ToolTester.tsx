...
const ToolTester: React.FC = () => {
  ...
  const availableTools = toolsList?.data || [];
  ...
  const renderParameterField = (paramName: string, param: any) => {
    const fieldProps = {
      ...
      helperText: errors[paramName]?.message,
    };
                      ...
                      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                        <Box display="flex" alignItems="center" gap={2} width="100%">
                          ...
                          <Typography variant="body2" sx={{ flexGrow: 1 }}>
                            {entry.result.timestamp.toLocaleTimeString()}
                          </Typography>
                          <Chip 
                      ...
                      <AccordionDetails>
                        <Grid container spacing={2}>
                          ...
                          <Grid item xs={12} md={6}>
                            ...
                            <Paper elevation={1} sx={{ p: 1, backgroundColor: 'grey.50' }}>
                              <pre style={{ fontSize: '11px', margin: 0 }}>
                                {formatJson(entry.result.response || entry.result.error)}
                              </pre>
                            </Paper>
                          </Grid>
                        </Grid>
