...
import {
  ...
  TextField, Snackbar, CircularProgress, useTheme, Paper, Dialog, DialogTitle, DialogContent, DialogActions
} from "@mui/material";
...
export default function AiConfig() {
  ...
  return (
    <Box sx={{ width: '100vw', height: '100vh', background: theme.palette.background.default, display: 'flex', flexDirection: 'column', alignItems: 'center', p: 0 }}>
      <Box sx={{ maxWidth: 900, width: '100%', mt: 4 }}>
        <Card sx={{ p: 4, mb: 4, background: theme.palette.background.paper, boxShadow: '0 8px 32px 0 rgba(59,130,246,0.10)' }}>
          ...
          <Card sx={{ borderRadius: 2, boxShadow: '0 8px 32px 0 rgba(139,92,246,0.08)', background: theme.palette.background.paper }}>
            <CardContent sx={{ pb: 6 }}>
              {aiConfig && (
                <form
                  onSubmit={async (e) => {
